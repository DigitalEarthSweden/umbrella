...
export UPSTREAM_IMAGES="des-cloudnative-pg:1.30.1 des-cloudnativepg-pgbouncer:1 des-cloudnativepg-postgres:18 des-cloudnativepg-postgis:3 des-postgres:18-bookworm des-postgis:18-3.6 des-valkey:9.1"
